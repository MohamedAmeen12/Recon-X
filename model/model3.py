...
from tools.tech_fingerprint_tool import fingerprint_technologies
from tools.whatweb_tool import run_whatweb, extract_technologies_from_whatweb
...
def lookup_cve(tech_name, version=""):
    ...
    try:
        from tools.nvd_api_tool import get_nvd_client
