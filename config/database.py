    ...
    for attempt in range(MAX_RETRIES):
        try:
            ...
            try:
                ...
                subdomains_collection.create_index([("domain", 1), ("scanned_at", -1)])
                technologies_collection.create_index([("domain", 1), ("subdomain", 1)])
                technologies_collection.create_index([("domain", 1), ("scanned_at", -1)])
                anomalies_collection.create_index([("domain", 1), ("subdomain", 1)])
                crawled_endpoints_collection.create_index([("domain", 1), ("subdomain", 1)])
                recommendations_collection.create_index([("report_id", 1)])
                recommendations_collection.create_index([("host", 1), ("cve_id", 1)])
