...
**Generated At:** 2026-05-20 01:15:30 UTC
...
### 3.2 Traffic Anomaly on Host `testaspnet.vulnweb.com`
- **Anomaly Classifier Score:** `0.0332`
- **Metrics Logged:**
  - Packet Count: `0`
  - TCP SYN Count: `0`
  - Unique Source IPs: `0`
...
**Mathematical Justification:**
Rule-based signals detected: Missing Security Headers: 4/4 required headers absent (CSP, HSTS, X-Frame-Options, X-Content-Type-Options); Insecure Configuration: Server version header exposed; Insecure Cookies: 1 cookie(s) missing Secure/HttpOnly flags. Isolation Forest decision score 0.0332 is within normal baseline (above 0.0 threshold).
...
### 3.4 Traffic Anomaly on Host `www.vulnweb.com`
- **Anomaly Classifier Score:** `-0.001`
- **Metrics Logged:**
  - Packet Count: `0`
  - TCP SYN Count: `0`
...
### 3.5 Traffic Anomaly on Host `www.test.php.vulnweb.com`
- **Anomaly Classifier Score:** `-0.001`
- **Metrics Logged:**
  - Packet Count: `0`
  - TCP SYN Count: `0`
